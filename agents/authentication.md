...
5. **Run plugin tools** to understand authentication context:
   ```bash
...
- "Run `/syntek-dev-suite:frontend` to build login/registration UI"
- "Run `/syntek-dev-suite:qa-tester` to test authentication security"
- "Run `/syntek-dev-suite:notifications` to set up password reset emails"
- "Run `/syntek-dev-suite:gdpr` to ensure auth data handling compliance"
- "Run `/syntek-dev-suite:security` to audit access controls"
- "Run `/syntek-dev-suite:cicd` to configure auth-related secrets in deployment"
