...
These principles guide all code written in this project. They are derived from two of the most influential systems programmers — Rob Pike (co-creator of Go) and Linus Torvalds (creator of Linux). Together they emphasise simplicity, data-driven design, and avoiding premature optimisation.
...
- Reduce branches: fewer conditional statements make code faster (CPU branch prediction) and easier to reason about
...
- Avoid excessive indentation: deep nesting makes code hard to read, especially after staring at it for hours
